...
const unsigned int DELAY_BETWEEN_TICKS = 10;
...
class stepper {
  public:
    stepper(int IN1, int IN2, int IN3, int IN4): in1(IN1), in2(IN2), in3(IN3), in4(IN4) {
      pinMode(in1, OUTPUT);
      pinMode(in2, OUTPUT);
      pinMode(in3, OUTPUT);
      pinMode(in4, OUTPUT);
  ...
  private:
    bool dir = true;
    int in1, in2, in3, in4, dur;
    bool s = 0;
    int count, stepCount, tick, TStepCount = 0;
};
...
stepper stepper1(Pin1, Pin2, Pin3, Pin4);
